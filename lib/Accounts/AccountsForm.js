      ...
      <Row key={index}>
        <Col xs={12} md={6}>
          <Row>
            ...
            <Col xs={12}>
              <Field label="Payment Method" name={`${elem}.payment_method`} id={`${elem}.payment_method`} dataOptions={this.props.dropdown.payment_method_dd} validate={[Required]} component={Select} fullWidth />
            </Col>
          </Row>
        </Col>
        <Col xs={12} md={6}>
          <Row>
            <Col xs={12}>
              <Field label="Account Status" name={`${elem}.account_status`} id={`${elem}.account_status`} dataOptions={this.props.dropdown.status_dd} validate={[Required]} component={Select} fullWidth />
            </Col>
            <Col xs={12}>
