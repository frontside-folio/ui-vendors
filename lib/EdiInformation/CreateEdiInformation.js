...
import css from './EdiInformation.css';

class CreateEdiInformation extends Component {
  static propTypes = {
          ...
          <Row>
            ...
            <Col xs={12} md={6}>
              <Row>
                ...
                <Col xs={12}>
                  <Field label="Send To" name='di.edi_job.send_to_emails' id='send_to_emails' type="email" component={TextField} fullWidth />
                </Col>
                <Col xs={12}>
...
export default CreateEdiInformation;