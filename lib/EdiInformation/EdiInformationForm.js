...
class EdiInformationForm extends Component {
  ...
  render() {
    ...
    const connection_mode_dd = (parentResources.dropdown || {}).connection_mode_dd || [];
          ...
          <Accordion label="EDI Basic" id="ediBasicSection">
            <Row>
              <Col xs={12} md={6}>
                <Row>
                  <Col xs={12}>
                    <Field label="Vendor EID Code" name='edi.vendor_edi_code' id='vendor_edi_code' component={Select} dataOptions={vendor_edi_code_dd} fullWidth />
                  </Col>
                  <Col xs={12}>
                    <Field label="Vendor EID Code Type" name='edi.vendor_edi_type' id='vendor_edi_type' component={Select} dataOptions={vendor_edi_code_type_dd} fullWidth />
                  </Col>
                  <Col xs={12}>
                    <Field label="Library EID Code" name='edi.lib_edi_code' id='lib_edi_code' component={Select} dataOptions={library_edi_code_dd} fullWidth />
                  </Col>
                  <Col xs={12}>
                    <Field label="Library EID Code Type" name='edi.lib_edi_code_type' id='lib_edi_type' component={Select} dataOptions={library_edi_code_type_dd} marginBottom0={true} fullWidth />
                  </Col>
          ...
          <Accordion label="FTP Details" id="ftpDetailsSection">
            <Row>
              <Col xs={12} md={6}>
                <Row>
                  <Col xs={12}>
                    <Field label="FTP Format" name='edi.edi_ftp.format' id='edi_edit_ftp_format' component={Select} dataOptions={ftp_dd} fullWidth />
                  </Col>
                  <Col xs={12}>
              ...
              <Col xs={12} md={6}>
                <Row>
                  <Col xs={12}>
                    <Field label="FTP Transmission Mode" name='edi.edi_ftp.ftp_mode' id='edi_edi_ftp__mode' component={Select} dataOptions={transmission_mode_dd} fullWidth />
                  </Col>
                  <Col xs={12}>
                    <Field label="FTP Connection Mode" name='edi.edi_ftp.ftp_conn_mode' id='edi_edi_ftp_conn_mode' component={Select} dataOptions={connection_mode_dd} fullWidth />
                  </Col>
                  <Col xs={12}>
