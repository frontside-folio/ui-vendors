        ...
        <div className={css.horizontalLine}>
          ...
          {edi_ftp &&
            <Row>
              ...
              <Col xs={3}>
              <KeyValue label="FTP Port" value={_.toString(_.get(edi_ftp, ['ftp_port']))} />
              </Col>
              <Col xs={6}>
          ...
          {edi_ftp &&
            <Row>
              ...
              <Col xs={3}>
              <KeyValue label="Schedule EDI" value={_.toString(_.get(edi_job, ['schedule_edi']))} />
              </Col>
              <Col xs={3}>
              ...
              <Col xs={3}>
              <KeyValue label="Monday" value={_.toString(_.get(edi_job, ['is_monday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Tuesday" value={_.toString(_.get(edi_job, ['is_tuesday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Wednesday" value={_.toString(_.get(edi_job, ['is_wednesday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Thursday" value={_.toString(_.get(edi_job, ['is_thursday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Friday" value={_.toString(_.get(edi_job, ['is_friday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Saturday" value={_.toString(_.get(edi_job, ['is_saturday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Sunday" value={_.toString(_.get(edi_job, ['is_sunday']))} />
              </Col>
              <Col xs={3}>
                <KeyValue label="Send to Emails" value={_.get(edi_job, ['send_to_emails'], '')} />
              </Col>
              <Col xs={3}>
              <KeyValue label="Notify All EDI" value={_.toString(_.get(edi_job, ['notify_all_edi']))} />
              </Col>
              <Col xs={3}>
              <KeyValue label="Notify Invoice Only" value={_.toString(_.get(edi_job, ['notify_invoice_only']))} />
              </Col>
              <Col xs={3}>
              <KeyValue label="Notify Error Only" value={_.toString(_.get(edi_job, ['notify_error_only']))} />
              </Col>
            </Row>
          }
        </div>
