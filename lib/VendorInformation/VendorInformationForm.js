      ...
      <Row>
        <Col xs={12} md={6}>
          <Row>
            ...
            <Col xs={12}>
              <Field label="Vendor Currencies" name='vendor_currencies' id='vendor_currencies' component={Select} dataOptions={this.props.dropdown_currencies} style={{ height: '80px' }} fullWidth multiple />
            </Col>
          </Row>
        </Col>
        <Col xs={12} md={6}>
