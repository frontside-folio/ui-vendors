...
class CreateVendorInformation extends Component {
  ...
  render() {
    const { vendor_currencies_dropdown } = this.props;
    return (
      <div id="form-create-vendor-information">
        <hr />
        <Row>
          <Col xs={12}>
          ...
          <Col xs={12} md={6}>
            <Row>
              ...
              <Col xs={12}>
                <Field label="Payment Method" name='payment_method' id='payment_method' type="number" component={TextField} fullWidth />
              </Col>
              <Col xs={12}>
              ...
              <Col xs={12}>
                <Field label="Vendor Currencies" name='vendor_currencies' id='vendor_currencies' component={Select} dataOptions={vendor_currencies_dropdown} meta={'multiple':'true'} fullWidth  />
              </Col>
              <Col xs={12}>
              ...
              <Col xs={12}>
                <Field label="Liable for VAT" name='liable_for_vat' id='liable_for_vat' component={Checkbox} inline={true} />
              </Col>
            </Row>
          </Col>
          <Col xs={12} md={6}>
