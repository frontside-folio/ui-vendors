...
class CreateInterface extends Component {
  ...
  render() {
    return (
      <Row>
        <Col xs={12}>
          <FieldArray label="Create Interface" name="interfaces" id="create_interface" component={this.renderForm} />
          <br />
        </Col>
      </Row>
    );
  ...
  renderSubForm = (elem, index, fields) => {
    return (
      <Row key={index}>
        ...
        <Accordion label="Statistics" open={false}>
          <Row>
            <Col xs={12} md={6}>
              <Row>
                <Col xs={12}>
                  <Field label="Available" name={`${elem}.available`} id={`${elem}.available`} component={Checkbox} marginBottom0={true} inline={true} />
                </Col>
                <Col xs={12}>
                  <Field label="Delivery Method" name={`${elem}.delivery_method`} id={`${elem}.delivery_method`} component={Select} fullWidth dataOptions={this.props.dropddown.delivery_method_dd} />
                </Col>
                <Col xs={12}>
                  <Field label="Format" name={`${elem}.format`} id={`${elem}.format`} component={Select} fullWidth dataOptions={this.props.format_dd} />
                </Col>
                <Col xs={12}>
