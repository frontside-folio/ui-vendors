...
class EditVendor extends React.Component {
  static propTypes = {
    ...
    panePreloader: PropTypes.bool.isRequired,
  ...
  render() {
    ...
    const lastMenu = (<PaneMenu><Button type="submit" buttonStyle="primary paneHeaderNewButton" disabled={this.props.pristine || this.props.submitting}>Update</Button></PaneMenu>);
    ...
    const panePreloader = this.props.panePreloader;
