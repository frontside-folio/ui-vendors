...
class Main extends Component {
  // path: 'circulation/loans?query=(userId=!{user.id}) sortby id&limit=1000',
  // static handler(e) {
  ...
  static manifest = Object.freeze({
    ...
    vendor: {
      ...
      // path: 'vendor%{localRes.vendorQuery}'
    },
    vendorGETID: {
      type: 'okapi',
  ...
  componentWillMount() {
    this.props.mutator.localRes.replace({ vendorQuery: '?limit=1000' });
  }
