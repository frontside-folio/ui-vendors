...
class Main extends Component {
  ...
  render() {
    ...
    return (
      <Paneset>
        ...
        <PaneDetails onCloseDetails={this.onCloseDetails} onScanItem={this.onScanItem} {...this.state} {...this.props} />
      </Paneset>
    );
  }
  ...
  setDefaultQuery() {
    ...
    this.props.mutator.localRes.update({ query: `${query}`, filter: filter, sortBy: sortBy, sortOrder: sortOrder });
  }
  // Data
  getAllData() {
    let data = null;
  ...
  onChangeFilterUpdateQuery(filterCQL) {
    ...
    this.props.mutator.localRes.update({ filter: filter });
  }
  onClearFilter = (name) => {
  ...
  onHeaderClick = (e, data) => {
    ...
    this.props.mutator.localRes.update({ sortBy: sortBy, sortOrder: sortOrder });
  }
  // Pages / Panels
  addNewVendor = () => {
  ...
  onScanItem(query) {
    this.props.mutator.localRes.update({ query: 'query=(name=' + query + '*)' });
    this.setState({ searchTerm: query, scanned_data_key: query });
  }
}
