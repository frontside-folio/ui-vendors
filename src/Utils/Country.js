module.exports = [
  ...
  { label: 'Hong Kong, SAR China', value: 'HKG' },
  { label: 'Macao, SAR China', value: 'MAC' },
  ...
  { label: 'Macedonia, Republic of', value: 'MKD' },
  ...
  { label: 'Palestinian Territory', value: 'PSE' },
  ...
  { label: 'Saint Vincent and Grenadines', value: 'VCT' },
  ...
  { label: 'Syrian Arab Republic (Syria)', value: 'SYR' },
  { label: 'Taiwan, Republic of China', value: 'TWN' },
  ...
  { label: 'Venezuela (Bolivarian Republic)', value: 'VEN' },
  { label: 'Viet Nam', value: 'VNM' },
  { label: 'Virgin Islands, US', value: 'VIR' },
